...
class StartMenu:
    ...
    def __init__(self):
        ...
        self.heading_english = Label(root, text="(language learning program)", font=font_set(10), foreground="#555555")
        self.heading_english.place(x=560, y=141)
...
class FQMenu:
    ...
    def __init__(self):
        ...
        self.heading_english.place(x=582, y=103)
